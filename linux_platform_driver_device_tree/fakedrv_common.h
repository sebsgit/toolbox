...
*/
#define FAKEDRV_PLATFORM_NAME "fakedrv-platform-dev"

/*
    some extra "variant" of platform device, used to test the id-table based matching
*/
#define FAKEDRV_PLATFORM_NAME_VARIANT_A "fplt-drv-variant-a"
#define FAKEDRV_PLATFORM_NAME_VARIANT_B "fplt-drv-variant-b"
